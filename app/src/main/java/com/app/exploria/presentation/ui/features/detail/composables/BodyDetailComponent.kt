...
@Composable
fun BodyDetailComponent(navController: NavController, destinationData: GetDestinationByIdResponse) {
    ...
    when (selectedTab) {
        ...
        1 -> ReviewFragment(id = destinationData.data.id, navController = navController)
